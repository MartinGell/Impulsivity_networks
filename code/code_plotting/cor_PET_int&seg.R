...
g_vals <- read_csv('/home/mgell/Work/FC/text_files/res/mean_all_FC_community_prop_21.csv')
g_vals <- g_vals[,7:9]
...
ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/', sert_file, '_by_Z_spearman_',
              as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)

plt <- plt + geom_text_repel(aes(label=roi), max.overlaps = 20)

ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/enki_labelled_', sert_file, '_by_Z_spearman_',
              as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)
...
ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/labelled_', sert_file,'_by_Z_pearson_',
              as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)
...
plt1 <- ggplot(d, aes(perm)) + geom_histogram(fill="skyblue3", alpha=0.5, bins = 40) +
  #scale_y_continuous(expand=c(0,0), limits = c(0,80), breaks = seq(0,600,100))+
...
ggsave(paste0('/home/mgell/Work/FC/plots/enki_5HT_perm_cor_Z.png'), plt1, width = 2, height = 2)
...
#   ylim(c(0,22)) + xlim(c(0,22))
# 
# ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/', NAT_file, '_by_ppos_spearman_',
#               as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)
# 
# plt <- plt + geom_text_repel(aes(label=roi), max.overlaps = 20)
# ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/labelled_', NAT_file, '_by_ppos_spearman_',
#               as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)
# 
# 
# # Pearson 
...
#   geom_text_repel(aes(label=roi), max.overlaps = 20)
# 
# ggsave(paste0('/home/mgell/Work/FC/PET/Association_plots/labelled_', NAT_file,'_by_ppos_pearson_',
#               as.character(round(c$estimate, digits = 2)), '.png'), plt, width = 4.5, height = 3.5)
# 
# 
# # Permutation
# # perm <- read_csv('/home/mgell//Work/FC/brainsmash/ppos_surrogate_maps.csv', col_NAT_files = FALSE)
# # 
...
# # 
# # # Get empirical data
# # #g_vals <- read_csv('/home/mgell/Work/FC/hcp/text_files/res/replic_5mm_mean_all_FC_community_prop.csv')
# # g_vals <- read_csv('/home/mgell/Work/FC/text_files/res/mean_all_FC_community_prop.csv')
# # receptor <- read_delim(paste0(wd, 'Imp_NAT_MRB_c11_2x2x2.nii.gz.txt'), delim = '\tab')
# # receptor <- receptor[,c(-2,-24,-25)]
# # receptor <- as.numeric(receptor[])
# # 
# # empirical <- cor(g_vals$ppos, receptor, method = 'spearman')
# # 
# # sum(surrogate_cors >= empirical) / 10000
# # 
# # remove(receptor,c)
